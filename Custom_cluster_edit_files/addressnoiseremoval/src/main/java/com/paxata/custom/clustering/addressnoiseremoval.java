 ...
 *
 */
public class addressnoiseremoval implements ClusterAlgorithm {
    ...
    private static final String ORG_DELETE_WORDS_PATH = "com/paxata/custom/clustering/address_noise_words.txt";

    public addressnoiseremoval() {
